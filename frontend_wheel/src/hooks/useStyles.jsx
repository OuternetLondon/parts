...
export const useStyles = () => {
  ...
  let font =
    "btn-sm btn-md btn-lg btn-xl text-blue-500 text-red-500 text-yellow-500 text-orange-500 text-green-500 text-purple-500 text-black text-white text text-primary, text-secondary, text-accent, text-neutral, text-info, text-success, text-warning, text-error, bg-[] bg-[radial-gradiant()] bg-[radial-gradient(ellipse_at_50%_75%,_${lightColor},_${color},_${darkColor})";

  let radial =
    " bg-radial-[at_50%_75%] from-white via-primary to-black to-90% bg-radial-[at_50%_75%] from-white via-secondary to-black to-90% bg-radial-[at_50%_75%] from-white via-accent to-black to-90% bg-radial-[at_50%_75%] from-white via-neutral to-black to-90% bg-radial-[at_50%_75%] from-white via-info to-black to-90% bg-radial-[at_50%_75%] from-white via-success to-black to-90% bg-radial-[at_50%_75%] from-white via-warning to-black to-90% bg-radial-[at_50%_75%] from-white via-error to-black to-90% bg-radial-[at_50%_75%] from-white via-blue-500 to-black to-90% bg-radial-[at_50%_75%] from-white via-red-500 to-black to-90% bg-radial-[at_50%_75%] from-white via-green-500 to-black to-90% bg-radial-[at_50%_75%] from-white via-yellow-500 to-black to-90% bg-radial-[at_50%_75%] from-white via-orange-500 to-black to-90% bg-radial-[at_50%_75%] from-white via-purple-500 to-black to-90% ";
  let font2 =
